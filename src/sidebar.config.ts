...
export const sidebar: StarlightUserConfig['sidebar'] = [
	{
		...
		items: [
			...
			},
			{
				...
				collapsed: true,
				autogenerate: {
					directory: 'cesky-jazyk/01-rozlisuje-subjektivni-a-hodnotici-sdeleni',
				},
			},
			{
			...
			},
			{
				...
				collapsed: true,
				autogenerate: {
					directory: 'cesky-jazyk/11-spisovny-jazyk-nareci-obecna-cestina',
				},
			},
			{
	...
	},
	{
		...
		items: [
			...
			{
				label: 'Informační a komunikační technologie',
				collapsed: true,
				items: [
					{
						label: 'Přehled',
						slug: 'ja-a-svet/informacni-a-komunikacni-technologie',
					},
					{
			...
			{
				label: 'Výchova k občanství',
				collapsed: true,
				items: [
					{
						label: 'Přehled',
						slug: 'ja-a-svet/vychova-k-obcanstvi',
					},
					{
			...
			{
				label: 'Výchova ke zdraví',
				collapsed: true,
				items: [
					{
						label: 'Přehled',
						slug: 'ja-a-svet/vychova-ke-zdravi',
					},
					{
			...
			{
				label: 'Člověk a svět práce',
				collapsed: true,
				items: [
					{
						label: 'Přehled',
						slug: 'ja-a-svet/clovek-a-svet-prace',
					},
					{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				collapsed: true,
				autogenerate: {
					directory: 'pohyb-umeni-kultura/09-esteticke-a-mimoesteticke-funkce',
				},
			},
			{
			...
			},
			{
				...
				collapsed: true,
				autogenerate: {
					directory: 'pohyb-umeni-kultura/13-rizika-psychoaktivnich-latek',
				},
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				collapsed: true,
				autogenerate: {
					directory: 'hry-relaxace-aktivity/07-fenomeny-prostrednictvim-hry',
				},
			},
			{
